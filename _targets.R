...
list(
  ...
  tar_target(boxplot_prey_vs_not_prey_abs, 
             boxplot_compare_compo_prey_not_prey_abs(fish_sp_means_and_scats)),
  tar_target(boxplot_prey_vs_not_prey_rel, 
             boxplot_compare_compo_prey_not_prey_rel(fish_sp_means_and_scats)),
  tar_target(barplot_cv_prey_vs_not_prey_rel, 
             barplot_cv_comp_nut_prey_not_prey(fish_sp_means_and_scats)),
  # table with the stats
  tar_target(table_stats_prey_vs_not_prey_rel, 
             table_compare_compo_prey_not_prey_abs(fish_sp_means_and_scats)),
  # stat tests of differences
  tar_target(MWtest_conc_prey_vs_not_prey_abs, 
             MWtest_compo_prey_not_prey_abs(fish_sp_means_and_scats)),
  tar_target(MWtest_conc_prey_vs_not_prey_rel_trace_only, 
             MWtest_compo_prey_not_prey_rel_trace_only(fish_sp_means_and_scats)),
  tar_target(MWtest_conc_prey_vs_not_prey_rel_all_nut, 
             MWtest_compo_prey_not_prey_rel_all_nut(fish_sp_means_and_scats)),
  ...
  # without means per species for fish and no pup suspicion in scats
  ...
  tar_target(boxplot_fish_full_and_scats_nopup, 
             boxplot_compare_compo_full(fish_full_and_scats_nopup, 
                                        "boxplot_comp_fish_full_scat_nopup_log")),
  ...
  tar_target(boxplot_fish_and_scats_relative_trace_nopup, 
             boxplot_compare_compo_fish_scat_relative_trace_only(fish_sp_means_and_scats_nopup, 
                                                                 "boxplot_comp_fish_scat_nopup_relative_trace")),
  ...
  tar_target(boxplot_fish_and_scats_relative_major_vs_trace, 
  ...
  # density plot comparison between composition of fish and scats 
  tar_target(densplot_fish_and_scats_nopup_norm_per_type, 
             densplot_compare_compo_full_norm_per_type(fish_sp_means_and_scats_nopup, 
                                                       "densplot_comp_fish_scat_nopup_norm_per_type")),
  tar_target(densplot_fish_full_and_scats_nopup_norm_per_type, 
             densplot_compare_compo_full_norm_per_type(fish_full_and_scats_nopup, 
                                                       "densplot_comp_fish_full_scat_nopup_norm_per_type")),
  ...
  # boxplot comparison between variability in nutrient composition of fish and 
  # scats 
  tar_target(boxplot_cv_per_nu_comp, 
  ...
  tar_target(MWtest_conc_rel_trace_only_fish_scats_nopup_table, 
             MWtest_conc_rel_fish_scats_trace_only(fish_sp_means_and_scats_nopup,  
                                                   "nopup")),
  ...
  tar_target(clust_fish_clean_PCs_scats_nopup_k3_ward_output, 
             clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                             ...
                             "output",
                             "both_clean_nopup_coda_rob_k3_ward")),
  tar_target(clust_fish_clean_PCs_scats_nopup_k3_ward_dendro_clust, 
             clust_compo_PCs_dendro_both(PCA_fish_clean_scats_nopup_coda_rob,
                                         fish_sp_means_clean_and_scats_nopup,
                                         method = "ward.D2", 
                                         k = 3, 
                                         colour = "Cluster", 
                                         file_name = "both_clean_nopup_PCs_rob")),

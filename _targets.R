...
list(
  ...
  tar_target(res_compo_fish_notechoutliers, 
  ...
  # add habitat to each species
  tar_target(full_res_compo_fish, add_eco_habitat_sp(res_compo_fish_notechoutliers)),
  ...
  tar_target(table_summary_compo_scats_output, 
             table_compo_scats(res_compo_scats_nooutliers, 
                               "output")),
  ...
  tar_target(fish_sp_means_and_scats_nopup, pool_fish_sp_means_scat(full_res_compo_fish, 
                                                                    full_res_compo_scats_nopup)),
  
  # boxplot comparison between composition of fish and scats 
  tar_target(boxplot_fish_and_scats_full, 
             boxplot_compare_compo_full(fish_sp_means_and_scats, 
                                        "boxplot_comp_fish_scat_log")),
  tar_target(boxplot_fish_and_scats_nopup, 
             boxplot_compare_compo_full(fish_sp_means_and_scats_nopup, 
                                        "boxplot_comp_fish_scat_nopup_log")),
  ...
  tar_target(fish_sp_means_clean, compo_fish_clean |> 
               dplyr::group_by(Family, habitat, Species) |> 
               dplyr::summarise(As = mean(As), 
                                Ca = mean(Ca), 
                                Co = mean(Co), 
                                Cu = mean(Cu), 
                                Fe = mean(Fe), 
  ...
  ####### with stat.outliers handle for fish and all samples for scats 
  # robust CoDa PCA analysis
  tar_target(PCA_fish_clean_scats_coda_rob, pca_coda(fish_sp_means_clean_and_scats,
                                                     "both")),
  ...
  tar_target(biplot_PCA_fish_clean_scats_coda_rob_PC13_ell,
             biplot_pca_coda(PCA_fish_clean_scats_coda_rob,
                             ...
                             ellipse = TRUE)),
  # non-robust CoDa PCA analysis
  tar_target(PCA_fish_clean_scats_coda_norob, pca_coda_norob(fish_sp_means_clean_and_scats,
                                                             "both")),
  ...
  tar_target(biplot_PCA_fish_clean_scats_coda_norob_PC13_ell,
             biplot_pca_coda(PCA_fish_clean_scats_coda_norob,
                             ...
                             ellipse = TRUE)),
  # classical PCA analysis
  tar_target(PCA_fish_clean_scats_nocoda, pca_nocoda(fish_sp_means_clean_and_scats,
                                                     "both")),
  ...
  # robust CoDa PCA analysis
  tar_target(PCA_fish_clean_scats_nopup_coda_rob, pca_coda(fish_sp_means_clean_and_scats_nopup,
                                                           "both")),
  ...
  tar_target(biplot_PCA_fish_clean_scats_nopup_coda_rob_PC13_ell,
             biplot_pca_coda(PCA_fish_clean_scats_nopup_coda_rob,
                             ...
                             ellipse = TRUE)),
  # non-robust CoDa PCA analysis
  tar_target(PCA_fish_clean_scats_nopup_coda_norob, pca_coda_norob(fish_sp_means_clean_and_scats_nopup,
                                                                   "both")),
  ...
  tar_target(biplot_PCA_fish_clean_scats_nopup_coda_norob_PC13_ell,
             biplot_pca_coda(PCA_fish_clean_scats_nopup_coda_norob,
                             ...
                             ellipse = TRUE)),
  # classical PCA analysis
  tar_target(PCA_fish_clean_scats_nopup_nocoda, pca_nocoda(fish_sp_means_clean_and_scats_nopup,
                                                           "both")),
  ...
  # dendrogram
  tar_target(clust_fish_tot_PCs_dendro_fam, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                   fish_sp_means_tot,
                                                                   method = "ward.D2", 
                                                                   k = 3, # not useful here to colour by Family
                                                                   colour = "Family", 
                                                                   file_name = "tot_PCs")),
  tar_target(clust_fish_tot_PCs_dendro_hab, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                   fish_sp_means_tot,
                                                                   method = "ward.D2", 
                                                                   ...
                                                                   file_name = "tot_PCs")),
  # hclust algorithm
  tar_target(findk_ward_fish_output, clust_find_k_table_PCs(PCA_fish_tot_coda_rob,
                                                            type = "fish",
                                                            k = c(2:10),
                                                            method = "ward.D2",
                                                            object_type = "output", 
                                                            file_name = "tot_PCs")),
  tar_target(findk_ward_fish_file, clust_find_k_table_PCs(PCA_fish_tot_coda_rob,
                                                          type = "fish",
                                                          k = c(2:10),
                                                          method = "ward.D2",
                                                          object_type = "file", 
  ...
  tar_target(findk_ward_means_fish, means_clust_find_k_val(findk_ward_fish_output,
                                                           ...
                                                           file_name = "tot_PCs")),
  # k = 4
  tar_target(clust_fish_tot_PCs_k4_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              type = "fish",
                                                              k = 4,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k4_ward")),
  tar_target(clust_fish_tot_PCs_k4_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                type = "fish",
                                                                k = 4,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k4_ward")),
  tar_target(clust_fish_tot_PCs_k4_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 4, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_tot_PCs_k4_ward, boxplot_compo_clust(clust_fish_tot_PCs_k4_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_tot_PCs_k4_ward")),
  tar_target(barplot_clust_fish_tot_PCs_k4_ward, barplot_clust(clust_fish_tot_PCs_k4_ward_output,
                                                               fish_sp_means_tot,
                                                               "fish_tot_PCs_k4_ward")),
  tar_target(biplot_clust_PCs_tot_k4_fish,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 2
  tar_target(clust_fish_tot_PCs_k2_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 2,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k2_ward")),
  tar_target(clust_fish_tot_PCs_k2_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 2,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k2_ward")),
  tar_target(clust_fish_tot_PCs_k2_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 2, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_tot_PCs_k2_ward, boxplot_compo_clust(clust_fish_tot_PCs_k2_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_tot_PCs_k2_ward")),
  tar_target(barplot_clust_fish_tot_PCs_k2_ward, barplot_clust(clust_fish_tot_PCs_k2_ward_output,
                                                               fish_sp_means_tot,
                                                               "fish_tot_PCs_k2_ward")),
  ...
  # k = 3
  tar_target(clust_fish_tot_PCs_k3_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 3,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k3_ward")),
  tar_target(clust_fish_tot_PCs_k3_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 3,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k3_ward")),
  tar_target(clust_fish_tot_PCs_k3_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 3, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_tot_PCs_k3_ward, boxplot_compo_clust(clust_fish_tot_PCs_k3_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_tot_PCs_k3_ward")),
  tar_target(barplot_clust_fish_tot_PCs_k3_ward, barplot_clust(clust_fish_tot_PCs_k3_ward_output,
                                                               fish_sp_means_tot,
                                                               "fish_tot_PCs_k3_ward")),
  tar_target(biplot_clust_fish_tot_PCs_k3,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 5
  tar_target(clust_fish_tot_PCs_k5_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 5,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k5_ward")),
  tar_target(clust_fish_tot_PCs_k5_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 5,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k5_ward")),
  tar_target(clust_fish_tot_PCs_k5_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 5, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_tot_PCs_k5_ward, boxplot_compo_clust(clust_fish_tot_PCs_k5_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_tot_PCs_k5_ward")),
  tar_target(barplot_clust_fish_tot_PCs_k5_ward, barplot_clust(clust_fish_tot_PCs_k5_ward_output,
                                                               fish_sp_means_tot,
                                                               "fish_tot_PCs_k5_ward")),
  tar_target(biplot_clust_fish_tot_PCs_k5,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 6
  tar_target(clust_fish_tot_PCs_k6_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 6,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k6_ward")),
  tar_target(clust_fish_tot_PCs_k6_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 6,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k6_ward")),
  tar_target(clust_fish_tot_PCs_k6_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 6, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_tot_PCs_k6_ward, boxplot_compo_clust(clust_fish_tot_PCs_k6_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_tot_PCs_k6_ward")),
  tar_target(barplot_clust_fish_tot_PCs_k6_ward, barplot_clust(clust_fish_tot_PCs_k6_ward_output,
                                                               fish_sp_means_tot,
                                                               "fish_tot_PCs_k6_ward")),
  ...
  # using PCs of PCA computed with mean per species
  # dendrogram
  tar_target(clust_fish_clean_PCs_dendro_fam, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                     fish_sp_means_clean,
                                                                     method = "ward.D2", 
                                                                     k = 3, # not useful here to colour by Family
                                                                     colour = "Family", 
                                                                     file_name = "clean_PCs")),
  tar_target(clust_fish_clean_PCs_dendro_hab, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                     fish_sp_means_clean,
                                                                     method = "ward.D2", 
                                                                     ...
                                                                     file_name = "clean_PCs")),
  # hclust algorithm
  tar_target(findk_ward_fish_clean_output, clust_find_k_table_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = c(2:10),
                                                                  method = "ward.D2",
                                                                  object_type = "output", 
                                                                  file_name = "clean_PCs")),
  tar_target(findk_ward_fish_clean_file, clust_find_k_table_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = c(2:10),
                                                                method = "ward.D2",
                                                                object_type = "file", 
                                                                file_name = "clean_PCs")),
  tar_target(findk_ward_boxplot_fish_clean, boxplot_clust_find_k_val(findk_ward_fish_clean_output,
                                                                     "fish", 
                                                                     file_name = "clean_PCs")),
  tar_target(findk_ward_means_fish_clean, means_clust_find_k_val(findk_ward_fish_clean_output,
                                                                 "fish", 
                                                                 file_name = "clean_PCs")),
  # k = 3
  tar_target(clust_fish_clean_PCs_k3_ward_file, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = 3,
                                                                method = "ward.D2",
                                                                "file",
                                                                "fish_clean_coda_rob_k3_ward")),
  tar_target(clust_fish_clean_PCs_k3_ward_output, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = 3,
                                                                  method = "ward.D2",
                                                                  "output",
                                                                  "fish_clean_coda_rob_k3_ward")),
  tar_target(clust_fish_clean_PCs_k3_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                    fish_sp_means_clean,
                                                                    method = "ward.D2", 
                                                                    k = 3, 
                                                                    colour = "Cluster", 
                                                                    file_name = "fish_clean_PCs")),
  tar_target(boxplot_clust_fish_clean_PCs_k3_ward, boxplot_compo_clust(clust_fish_clean_PCs_k3_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_PCs_k3_ward")),
  tar_target(barplot_clust_fish_clean_PCs_k3_ward, barplot_clust(clust_fish_clean_PCs_k3_ward_output,
                                                                 fish_sp_means_clean,
                                                                 "fish_clean_PCs_k3_ward")),
  tar_target(biplot_clust_fish_clean_PCs_k3,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 4
  tar_target(clust_fish_clean_PCs_k4_ward_file, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = 4,
                                                                method = "ward.D2",
                                                                "file",
                                                                "fish_clean_coda_rob_k4_ward")),
  tar_target(clust_fish_clean_PCs_k4_ward_output, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = 4,
                                                                  method = "ward.D2",
                                                                  "output",
                                                                  "fish_clean_coda_rob_k4_ward")),
  tar_target(clust_fish_clean_PCs_k4_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                    fish_sp_means_clean,
                                                                    method = "ward.D2", 
                                                                    k = 4, 
                                                                    colour = "Cluster", 
                                                                    file_name = "fish_clean_PCs")),
  tar_target(boxplot_clust_fish_clean_PCs_k4_ward, boxplot_compo_clust(clust_fish_clean_PCs_k4_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_PCs_k4_ward")),
  tar_target(barplot_clust_fish_clean_PCs_k4_ward, barplot_clust(clust_fish_clean_PCs_k4_ward_output,
                                                                 fish_sp_means_clean,
                                                                 "fish_clean_PCs_k4_ward")),
  tar_target(biplot_clust_fish_clean_PCs_k4,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 5
  tar_target(clust_fish_clean_PCs_k5_ward_file, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = 5,
                                                                method = "ward.D2",
                                                                "file",
                                                                "fish_clean_coda_rob_k5_ward")),
  tar_target(clust_fish_clean_PCs_k5_ward_output, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = 5,
                                                                  method = "ward.D2",
                                                                  "output",
                                                                  "fish_clean_coda_rob_k5_ward")),
  tar_target(clust_fish_clean_PCs_k5_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                    fish_sp_means_clean,
                                                                    method = "ward.D2", 
                                                                    k = 5, 
                                                                    colour = "Cluster", 
                                                                    file_name = "fish_clean_PCs")),
  tar_target(boxplot_clust_fish_clean_PCs_k5_ward, boxplot_compo_clust(clust_fish_clean_PCs_k5_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_PCs_k5_ward")),
  tar_target(barplot_clust_fish_clean_PCs_k5_ward, barplot_clust(clust_fish_clean_PCs_k5_ward_output,
                                                                 fish_sp_means_clean,
                                                                 "fish_clean_PCs_k5_ward")),
  ...
  tar_target(findk_ward_fish_nutrients_output, clust_find_k_table(fish_sp_means_clean,
                                                                  type = "fish",
                                                                  k = c(2:10),
                                                                  nutrients = c("Fe", "As", 
                                                                                "Ni", "K", 
                                                                  ...
                                                                  object_type = "output")),
  # k = 2
  tar_target(clust_fish_clean_nutrients_k2_ward_output, clust_compo_full_tib(fish_sp_means_clean,
                                                                             type = "fish",
                                                                             nutrients = c("Fe", "As", 
                                                                                           "Ni", "K", 
                                                                                           "Se"),
  ...
  tar_target(biplot_clust_fish_clean_nutrients_k2,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 3
  tar_target(clust_fish_clean_nutrients_k3_ward_output, clust_compo_full_tib(fish_sp_means_clean,
                                                                             type = "fish",
                                                                             nutrients = c("Fe", "As", 
                                                                                           "Ni", "K", 
                                                                                           "Se"),
  ...
  tar_target(biplot_clust_fish_clean_nutrients_k3,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(boxplot_clust_fish_clean_nutrients_k3_ward, boxplot_compo_clust(clust_fish_clean_nutrients_k3_ward_output,
                                                                             fish_sp_means_clean,
                                                                             "fish_clean_nutrients_k3_ward")),
  tar_target(barplot_clust_fish_clean_nutrients_k3_ward, barplot_clust(clust_fish_clean_nutrients_k3_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_nutrients_k3_ward")),
  # k = 4
  tar_target(clust_fish_clean_nutrients_k4_ward_output, clust_compo_full_tib(fish_sp_means_clean,
                                                                             type = "fish",
                                                                             nutrients = c("Fe", "As", 
                                                                                           "Ni", "K", 
                                                                                           "Se"),
  ...
  tar_target(biplot_clust_fish_clean_nutrients_k4,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(boxplot_clust_fish_clean_nutrients_k4_ward, boxplot_compo_clust(clust_fish_clean_nutrients_k4_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_nutrients_k4_ward")),
  tar_target(barplot_clust_fish_clean_nutrients_k4_ward, barplot_clust(clust_fish_clean_nutrients_k4_ward_output,
                                                                 fish_sp_means_clean,
                                                                 "fish_clean_nutrients_k4_ward")),
  # k = 5
  tar_target(clust_fish_clean_nutrients_k5_ward_output, clust_compo_full_tib(fish_sp_means_clean,
                                                                             type = "fish",
                                                                             nutrients = c("Fe", "As", 
                                                                                           "Ni", "K", 
                                                                                           "Se"),
  ...
  tar_target(biplot_clust_fish_clean_nutrients_k5,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                ...
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(boxplot_clust_fish_clean_nutrients_k5_ward, boxplot_compo_clust(clust_fish_clean_nutrients_k5_ward_output,
                                                                             fish_sp_means_clean,
                                                                             "fish_clean_nutrients_k5_ward")),
  tar_target(barplot_clust_fish_clean_nutrients_k5_ward, barplot_clust(clust_fish_clean_nutrients_k5_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_clean_nutrients_k5_ward")),
  ...
  # hclust algorithm
  tar_target(findk_ward_scats_tot_output, clust_find_k_table_PCs(PCA_scats_tot_coda_rob,
                                                                 type = "scats",
                                                                 k = c(2:10),
                                                                 method = "ward.D2",
                                                                 object_type = "output", 
                                                                 file_name = "tot_PCs")),
  tar_target(findk_ward_scats_tot_file, clust_find_k_table_PCs(PCA_scats_tot_coda_rob,
                                                               type = "scats",
                                                               k = c(2:10),
                                                               method = "ward.D2",
                                                               object_type = "file", 
                                                               file_name = "tot_PCs")),
  tar_target(findk_ward_boxplot_scats_tot, boxplot_clust_find_k_val(findk_ward_scats_tot_output,
                                                                    "scats", 
                                                                    file_name = "tot_PCs")),
  tar_target(findk_ward_means_scats_tot, means_clust_find_k_val(findk_ward_scats_tot_output,
                                                                "scats", 
                                                                file_name = "tot_PCs")),
  # k = 4
  tar_target(clust_scats_PCs_tot_k4_ward_file, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                               type = "scats",
                                                               k = 4,
                                                               method = "ward.D2",
                                                               "file",
                                                               "scats_tot_coda_rob_k4_ward")),
  tar_target(clust_scats_PCs_tot_k4_ward_output, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                                 type = "scats",
                                                                 k = 4,
                                                                 method = "ward.D2",
                                                                 "output",
                                                                 "scats_tot_coda_rob_k4_ward")),
  tar_target(boxplot_clust_scats_PCs_tot_k4_ward, boxplot_compo_clust(clust_scats_PCs_tot_k4_ward_output,
                                                                      full_res_compo_scats,
                                                                      "scats_PCs_tot_k4_ward")),
  tar_target(barplot_clust_scats_PCs_tot_k4_ward, barplot_clust(clust_scats_PCs_tot_k4_ward_output,
                                                                full_res_compo_scats,
                                                                "scats_PCs_tot_k4_ward")),
  tar_target(biplot_clust_PCs_tot_k4_scats,
             biplot_after_clust(PCA_scats_tot_coda_rob,
                                clust_scats_PCs_tot_k4_ward_output,
                                full_res_compo_scats,
                                "scats",
                                "PCs_tot_k4_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  # k = 2
  tar_target(clust_scats_PCs_tot_k2_ward_file, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                               "scats",
                                                               k = 2,
                                                               method = "ward.D2",
                                                               "file",
                                                               "scats_tot_coda_rob_k2_ward")),
  tar_target(clust_scats_PCs_tot_k2_ward_output, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                                 "scats",
                                                                 k = 2,
                                                                 method = "ward.D2",
                                                                 "output",
                                                                 "scats_tot_coda_rob_k2_ward")),
  tar_target(boxplot_clust_scats_PCs_tot_k2_ward, boxplot_compo_clust(clust_scats_PCs_tot_k2_ward_output,
                                                                      full_res_compo_scats,
                                                                      "scats_PCs_tot_k2_ward")),
  tar_target(barplot_clust_scats_PCs_tot_k2_ward, barplot_clust(clust_scats_PCs_tot_k2_ward_output,
                                                                full_res_compo_scats,
                                                                "scats_PCs_tot_k2_ward")),
  tar_target(biplot_clust_scats_PCs_tot_k2,
             biplot_after_clust(PCA_scats_tot_coda_rob,
                                clust_scats_PCs_tot_k2_ward_output,
                                full_res_compo_scats,
                                "scats",
                                "PCs_tot_coda_rob_k2_ward",
                                pcomp = c(1:2),
  ...
  # k = 3
  tar_target(clust_scats_PCs_tot_k3_ward_file, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                               "scats",
                                                               k = 3,
                                                               method = "ward.D2",
                                                               "file",
                                                               "scats_tot_coda_rob_k3_ward")),
  tar_target(clust_scats_PCs_tot_k3_ward_output, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                                 "scats",
                                                                 k = 3,
                                                                 method = "ward.D2",
                                                                 "output",
                                                                 "scats_tot_coda_rob_k3_ward")),
  tar_target(boxplot_clust_scats_PCs_tot_k3_ward, boxplot_compo_clust(clust_scats_PCs_tot_k3_ward_output,
                                                                      full_res_compo_scats,
                                                                      "scats_PCs_tot_k3_ward")),
  tar_target(barplot_clust_scats_PCs_tot_k3_ward, barplot_clust(clust_scats_PCs_tot_k3_ward_output,
                                                                full_res_compo_scats,
                                                                "scats_PCs_tot_k3_ward")),
  tar_target(biplot_clust_scats_PCs_tot_k3,
             biplot_after_clust(PCA_scats_tot_coda_rob,
                                clust_scats_PCs_tot_k3_ward_output,
                                full_res_compo_scats,
                                "scats",
                                "PCs_tot_coda_rob_k3_ward",
                                pcomp = c(1:2),
  ...
  # using PCs of PCA coda rob
  # hclust algorithm
  tar_target(findk_ward_scats_nopup_output, clust_find_k_table_PCs(PCA_scats_nopup_coda_rob,
                                                                   type = "scats",
                                                                   k = c(2:10),
                                                                   method = "ward.D2",
                                                                   object_type = "output", 
                                                                   file_name = "nopup_PCs")),
  tar_target(findk_ward_scats_nopup_file, clust_find_k_table_PCs(PCA_scats_nopup_coda_rob,
                                                                 type = "scats",
                                                                 k = c(2:10),
                                                                 method = "ward.D2",
                                                                 object_type = "file", 
                                                                 file_name = "nopup_PCs")),
  tar_target(findk_ward_boxplot_scats_nopup, boxplot_clust_find_k_val(findk_ward_scats_nopup_output,
                                                                      "scats", 
                                                                      file_name = "nopup_PCs")),
  tar_target(findk_ward_means_scats_nopup, means_clust_find_k_val(findk_ward_scats_nopup_output,
                                                                  "scats", 
                                                                  file_name = "nopup_PCs")),
  # k = 2
  tar_target(clust_scats_PCs_nopup_k2_ward_file, clust_compo_PCs(PCA_scats_nopup_coda_rob,
                                                                 "scats",
                                                                 k = 2,
                                                                 method = "ward.D2",
                                                                 "file",
                                                                 "scats_nopup_coda_rob_k2_ward")),
  tar_target(clust_scats_PCs_nopup_k2_ward_output, clust_compo_PCs(PCA_scats_nopup_coda_rob,
                                                                   "scats",
                                                                   k = 2,
                                                                   method = "ward.D2",
                                                                   "output",
                                                                   "scats_nopup_coda_rob_k2_ward")),
  tar_target(boxplot_clust_scats_PCs_nopup_k2_ward, boxplot_compo_clust(clust_scats_PCs_nopup_k2_ward_output,
                                                                        full_res_compo_scats_nopup,
                                                                        "scats_PCs_nopup_k2_ward")),
  tar_target(barplot_clust_scats_PCs_nopup_k2_ward, barplot_clust(clust_scats_PCs_nopup_k2_ward_output,
                                                                  full_res_compo_scats_nopup,
                                                                  "scats_PCs_nopup_k2_ward")),
  tar_target(biplot_clust_scats_PCs_nopup_k2,
             biplot_after_clust(PCA_scats_nopup_coda_rob,
                                clust_scats_PCs_nopup_k2_ward_output,
                                full_res_compo_scats_nopup,
                                "scats",
  ...
  # k = 3
  tar_target(clust_scats_PCs_nopup_k3_ward_file, clust_compo_PCs(PCA_scats_nopup_coda_rob,
                                                                 "scats",
                                                                 k = 3,
                                                                 method = "ward.D2",
                                                                 "file",
                                                                 "scats_nopup_coda_rob_k3_ward")),
  tar_target(clust_scats_PCs_nopup_k3_ward_output, clust_compo_PCs(PCA_scats_nopup_coda_rob,
                                                                   "scats",
                                                                   k = 3,
                                                                   method = "ward.D2",
                                                                   "output",
                                                                   "scats_nopup_coda_rob_k3_ward")),
  tar_target(boxplot_clust_scats_PCs_nopup_k3_ward, boxplot_compo_clust(clust_scats_PCs_nopup_k3_ward_output,
                                                                        full_res_compo_scats_nopup,
                                                                        "scats_PCs_nopup_k3_ward")),
  tar_target(barplot_clust_scats_PCs_nopup_k3_ward, barplot_clust(clust_scats_PCs_nopup_k3_ward_output,
                                                                  full_res_compo_scats_nopup,
                                                                  "scats_PCs_nopup_k3_ward")),
  tar_target(biplot_clust_scats_PCs_nopup_k3,
             biplot_after_clust(PCA_scats_nopup_coda_rob,
                                clust_scats_PCs_nopup_k3_ward_output,
                                full_res_compo_scats_nopup,
                                "scats",
  ...
  # using PCs of PCA coda rob
  # hclust algorithm
  tar_target(findk_ward_fish_clean_scats_nopup_output, clust_find_k_table_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                              type = "both",
                                                                              k = c(2:10),
                                                                              method = "ward.D2",
                                                                              object_type = "output", 
                                                                              file_name = "clean_nopup_PCs")),
  tar_target(findk_ward_fish_clean_scats_nopup_file, clust_find_k_table_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                            type = "both",
                                                                            k = c(2:10),
                                                                            method = "ward.D2",
                                                                            object_type = "file", 
                                                                            file_name = "clean_nopup_PCs")),
  tar_target(findk_ward_boxplot_fish_clean_scats_nopup, boxplot_clust_find_k_val(findk_ward_fish_clean_scats_nopup_output,
                                                                                 "both", 
                                                                                 file_name = "nopup_PCs")),
  tar_target(findk_ward_means_fish_clean_scats_nopup, means_clust_find_k_val(findk_ward_fish_clean_scats_nopup_output,
                                                                             "both", 
                                                                             file_name = "clean_nopup_PCs")),
  # k = 2
  tar_target(clust_fish_clean_scats_PCs_nopup_k2_ward_file, clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                            "both",
                                                                            k = 2,
                                                                            method = "ward.D2",
                                                                            "file",
                                                                            "both_clean_nopup_coda_rob_k2_ward")),
  tar_target(clust_fish_clean_scats_PCs_nopup_k2_ward_output, clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                              "both",
                                                                              k = 2,
                                                                              method = "ward.D2",
                                                                              "output",
                                                                              "both_clean_nopup_coda_rob_k2_ward")),
  tar_target(boxplot_clust_fish_clean_scats_PCs_nopup_k2_ward, boxplot_compo_clust(clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                                                                   fish_sp_means_clean_and_scats_nopup,
                                                                                   "both_PCs_clean_nopup_k2_ward")),
  tar_target(barplot_clust_fish_clean_scats_PCs_nopup_k2_ward, barplot_clust(clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                                                             fish_sp_means_clean_and_scats_nopup,
                                                                             "both_PCs_clean_nopup_k2_ward")),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2_PC13,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward_PC13",
                                pcomp = c(1,3),
                                var.add.scaling = 2.5)),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2_PC23,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward_PC23",
                                pcomp = c(2,3),
                                var.add.scaling = 2.5)),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2_PC14,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward_PC14",
                                pcomp = c(1,4),
                                var.add.scaling = 2.5)),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2_PC24,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward_PC24",
                                pcomp = c(2,4),
                                var.add.scaling = 2.5)),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k2_PC34,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k2_ward_PC34",
                                pcomp = c(3,4),
                                var.add.scaling = 2.5)),
  
  # k = 3
  tar_target(clust_fish_clean_scats_PCs_nopup_k3_ward_file, clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                            "both",
                                                                            k = 3,
                                                                            method = "ward.D2",
                                                                            "file",
                                                                            "both_clean_nopup_coda_rob_k3_ward")),
  tar_target(clust_fish_clean_scats_PCs_nopup_k3_ward_output, clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                                                                              "both",
                                                                              k = 3,
                                                                              method = "ward.D2",
                                                                              "output",
                                                                              "both_clean_nopup_coda_rob_k3_ward")),
  tar_target(boxplot_clust_fish_clean_scats_PCs_nopup_k3_ward, boxplot_compo_clust(clust_fish_clean_scats_PCs_nopup_k3_ward_output,
                                                                                   fish_sp_means_clean_and_scats_nopup,
                                                                                   "both_PCs_clean_nopup_k3_ward")),
  tar_target(barplot_clust_fish_clean_scats_PCs_nopup_k3_ward, barplot_clust(clust_fish_clean_scats_PCs_nopup_k3_ward_output,
                                                                             fish_sp_means_clean_and_scats_nopup,
                                                                             "both_PCs_clean_nopup_k3_ward")),
  tar_target(biplot_clust_fish_clean_scats_PCs_nopup_k3,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_scats_PCs_nopup_k3_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_clean_nopup_coda_rob_k3_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # trying on real concentrations using algorithm for compositional dataset
  # and only a few nutrients identified as structuring with PCAs
  tar_target(findk_ward_fish_clean_and_scats_nopup_nutrients_output, clust_find_k_table(fish_sp_means_clean_and_scats_nopup,
                                                                                        type = "both",
                                                                                        k = c(2:10),
                                                                                        nutrients = c("Fe", "Cu", 
                                                                                                      "As", "K", 
                                                                                        ...
                                                                                        method = "ward.D2",
                                                                                        object_type = "output")),
  tar_target(findk_ward_fish_clean_and_scats_nopup_nutrients_file, clust_find_k_table(fish_sp_means_clean_and_scats_nopup,
                                                                                        type = "both",
                                                                                        k = c(2:10),
                                                                                        nutrients = c("Fe", "Cu", 
                                                                                                      "As", "K", 
                                                                                        ...
                                                                                        object_type = "file")),
  # k = 2
  tar_target(clust_fish_clean_and_scats_nopup_nutrients_k2_ward_output, clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                                                                             type = "both",
                                                                                             nutrients = c("Fe", "Cu", 
                                                                                                           "As", "K", 
                                                                                                           "Ca", "Na"),
                                                                                             k = 2,
                                                                                             method = "ward.D2")),
  tar_target(barplot_clust_fish_clean_and_scats_nopup_nutrients_k2_ward, barplot_clust(clust_fish_clean_and_scats_nopup_nutrients_k2_ward_output,
                                                                                       fish_sp_means_clean_and_scats_nopup,
                                                                                       "both_nutrients_FeCuAsKCaNa_clean_nopup_k2_ward")),
  tar_target(biplot_clust_fish_clean_and_scats_nopup_nutrients_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_and_scats_nopup_nutrients_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeCuAsKCaNa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  # with other nutrients 
  tar_target(clust_fish_clean_and_scats_nopup_nutrients_FePAsKCaNa_k2_ward_output, clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                                                                             type = "both",
                                                                                             nutrients = c("Fe", "P", 
                                                                                                           "As", "K", 
                                                                                                           "Ca", "Na"),
                                                                                             k = 2,
                                                                                             method = "ward.D2")),
  tar_target(barplot_clust_fish_clean_and_scats_nopup_nutrients_FePAsKCaNa_k2_ward, barplot_clust(clust_fish_clean_and_scats_nopup_nutrients_FePAsKCaNa_k2_ward_output,
                                                                                       fish_sp_means_clean_and_scats_nopup,
                                                                                       "both_nutrients_FePAsKCaNa_clean_nopup_k2_ward")),
  tar_target(biplot_clust_fish_clean_and_scats_nopup_nutrients_FePAsKCaNa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_and_scats_nopup_nutrients_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FePAsKCaNa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  # k = 3
  tar_target(clust_fish_clean_and_scats_nopup_nutrients_k3_ward_output, clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                                                                             type = "both",
                                                                                             nutrients = c("Fe", "Cu", 
                                                                                                           "As", "K", 
                                                                                                           "Ca", "Na"),
                                                                                             k = 3,
                                                                                             method = "ward.D2")),
  tar_target(biplot_clust_fish_clean_and_scats_nopup_nutrients_k3,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_and_scats_nopup_nutrients_k3_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_k3_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5))

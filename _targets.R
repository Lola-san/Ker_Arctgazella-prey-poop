...
list(
  ...
  tar_target(findk_ward_fish_file, clust_find_k_table(full_res_compo_fish, 
                                                      ...
                                                      method = "ward.D2", 
                                                      object_type = "file")), 
  tar_target(findk_ward_boxplot_fish, boxplot_clust_find_k(findk_ward_fish_output, 
                                                           "fish")),
  tar_target(findk_ward_means_fish, means_clust_find_k(findk_ward_fish_output, 
                                                       "fish")),
  ...
  tar_target(findk_ward_scats_file, clust_find_k_table(full_res_compo_scats, 
                                                       ...
                                                       method = "ward.D2", 
                                                       object_type = "file")), 
  tar_target(findk_ward_boxplot_scats, boxplot_clust_find_k(findk_ward_scats_output, 
                                                            "scats")),
  tar_target(findk_ward_means_scats, means_clust_find_k(findk_ward_scats_output, 
                                                        "scats")),
  ...
  tar_target(findk_ward_fish_and_scats_file, clust_find_k_table(fish_and_scats, 
                                                                ...
                                                                method = "ward.D2", 
                                                                object_type = "file")), 
  tar_target(findk_ward_boxplot_fish_and_scats, boxplot_clust_find_k(findk_ward_fish_and_scats_output, 
                                                                     "both")),
  tar_target(findk_ward_means_fish_and_scats, means_clust_find_k(findk_ward_fish_and_scats_output, 
                                                                 "both")),

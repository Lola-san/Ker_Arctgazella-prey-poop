...
list(
  ...
  # dendrogram
  tar_target(clust_fish_tot_PCs_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                               fish_sp_means_tot,
                                                               method = "ward.D2", 
  ...
  tar_target(barplot_clust_fish_tot_PCs_k4_ward, barplot_fam_clust(clust_fish_tot_PCs_k4_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_tot_PCs_k4_ward")),
  ...
  tar_target(barplot_clust_fish_tot_PCs_k2_ward, barplot_fam_clust(clust_fish_tot_PCs_k2_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_tot_PCs_k2_ward")),
  ...
  tar_target(barplot_clust_fish_tot_PCs_k3_ward, barplot_fam_clust(clust_fish_tot_PCs_k3_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_tot_PCs_k3_ward")),
  ...
  tar_target(barplot_clust_fish_tot_PCs_k5_ward, barplot_fam_clust(clust_fish_tot_PCs_k5_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_tot_PCs_k5_ward")),
  ...
  tar_target(barplot_clust_fish_tot_PCs_k6_ward, barplot_fam_clust(clust_fish_tot_PCs_k6_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_tot_PCs_k6_ward")),
  ...
  # using PCs of PCA computed with mean per species
  # dendrogram
  tar_target(clust_fish_clean_PCs_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                 fish_sp_means_clean,
                                                                 method = "ward.D2", 
                                                                 k = 3, # not useful here to colour by Family
                                                                 colour = "Family", 
  ...
  tar_target(barplot_clust_fish_clean_PCs_k4_ward, barplot_fam_clust(clust_fish_clean_PCs_k4_ward_output,
                                                                     fish_sp_means_clean,
                                                                     "fish_clean_PCs_k4_ward")),
  ...
  tar_target(barplot_clust_fish_clean_PCs_k5_ward, barplot_fam_clust(clust_fish_clean_PCs_k5_ward_output,
                                                                     fish_sp_means_clean,
                                                                     "fish_clean_PCs_k5_ward")),

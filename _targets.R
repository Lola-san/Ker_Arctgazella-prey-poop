...
list(
  ...
  tar_target(PCA_fish_clean_scats_nopup_coda_rob_nut_loadings_PCs, pca_coda_loadings_nut(PCA_fish_clean_scats_nopup_coda_rob, 
                                                                                         "both",
  ...
  # dendrogram
  tar_target(clust_fish_tot_PCs_dendro_fam, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                        fish_sp_means_tot,
                                                                        method = "ward.D2", 
                                                                        k = 3, # not useful here to colour by Family
                                                                        colour = "Family", 
                                                                        file_name = "tot_PCs")),
  tar_target(clust_fish_tot_PCs_dendro_hab, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                        fish_sp_means_tot,
                                                                        method = "ward.D2", 
  ...
  tar_target(clust_fish_tot_PCs_k4_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                ...
                                                                "output",
                                                                "fish_tot_coda_rob_k4_ward")),
  tar_target(clust_fish_tot_PCs_k4_dendro, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                       fish_sp_means_tot,
                                                                       method = "ward.D2", 
                                                                       k = 4, 
                                                                       colour = "Cluster", 
  ...
  tar_target(clust_fish_tot_PCs_k2_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                ...
                                                                "output",
                                                                "fish_tot_coda_rob_k2_ward")),
  tar_target(clust_fish_tot_PCs_k2_dendro, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                       fish_sp_means_tot,
                                                                       method = "ward.D2", 
                                                                       k = 2, 
                                                                       colour = "Cluster", 
  ...
  tar_target(clust_fish_tot_PCs_k3_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                ...
                                                                "output",
                                                                "fish_tot_coda_rob_k3_ward")),
  tar_target(clust_fish_tot_PCs_k3_dendro, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                       fish_sp_means_tot,
                                                                       method = "ward.D2", 
                                                                       k = 3, 
                                                                       colour = "Cluster", 
  ...
  tar_target(clust_fish_tot_PCs_k5_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                ...
                                                                "output",
                                                                "fish_tot_coda_rob_k5_ward")),
  tar_target(clust_fish_tot_PCs_k5_dendro, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                       fish_sp_means_tot,
                                                                       method = "ward.D2", 
                                                                       k = 5, 
                                                                       colour = "Cluster", 
  ...
  tar_target(clust_fish_tot_PCs_k6_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                ...
                                                                "output",
                                                                "fish_tot_coda_rob_k6_ward")),
  tar_target(clust_fish_tot_PCs_k6_dendro, clust_compo_PCs_dendro_fish(PCA_fish_tot_coda_rob,
                                                                       fish_sp_means_tot,
                                                                       method = "ward.D2", 
                                                                       k = 6, 
                                                                       colour = "Cluster", 
  ...
  tar_target(clust_PCs_scats_nopup_k2_dendro_HPI01, 
             clust_compo_PCs_dendro_scats(PCA_scats_nopup_coda_rob,
                                          full_res_compo_scats_nopup,
                                          method = "ward.D2", 
                                          k = 2, 
  ...
  tar_target(biplot_clust_fish_clean_PCs_scats_nopup_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                ...
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(clust_fish_clean_PCs_scats_nopup_k2_dendro_type, 
             clust_compo_PCs_dendro_both(PCA_fish_clean_scats_nopup_coda_rob,
                                         fish_sp_means_clean_and_scats_nopup,
                                         method = "ward.D2", 
                                         k = 2, 
                                         colour = "type", 
                                         file_name = "both_PCs_clean_nopup")),
  ...
  tar_target(biplot_clust_fish_clean_PCs_scats_nopup_k2_PC34,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 2
  tar_target(clust_fish_clean_scats_nopup_PCs_norob_k2_ward_file, 
             clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_norob,
                             "both",
                             k = 2,
                             method = "ward.D2",
                             "file",
                             "both_clean_nopup_coda_norob_k2_ward")),
  tar_target(clust_fish_clean_scats_nopup_PCs_norob_k2_ward_output, 
             clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_norob,
                             "both",
                             k = 2,
                             method = "ward.D2",
                             "output",
                             "both_clean_nopup_coda_norob_k2_ward")),
  tar_target(boxplot_clust_fish_clean_scats_nopup_PCs_norob_k2_ward, 
             boxplot_compo_clust(clust_fish_clean_scats_nopup_PCs_norob_k2_ward_output,
                                 fish_sp_means_clean_and_scats_nopup,
                                 "both_PCs_norob_clean_nopup_k2_ward")),
  tar_target(barplot_clust_fish_clean_scats_nopup_PCs_norob_k2_ward, 
             barplot_clust(clust_fish_clean_scats_nopup_PCs_norob_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_PCs_norob_clean_nopup_k2_ward")),
  tar_target(biplot_clust_fish_clean_scats_nopup_PCs_norob_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_norob,
                                clust_fish_clean_scats_nopup_PCs_norob_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "PCs_norob_clean_nopup_coda_norob_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(clust_fish_clean_scats_nopup_PCs_norob_k2_dendro_type, 
             clust_compo_PCs_dendro_both(PCA_fish_clean_scats_nopup_coda_norob,
                                         fish_sp_means_clean_and_scats_nopup,
                                         method = "ward.D2", 
                                         k = 2, 
                                         colour = "type", 
                                         file_name = "both_PCs_norob_clean_nopup")),
  
  # k = 3
  tar_target(clust_fish_clean_PCs_scats_nopup_k3_ward_file, 
             clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                             "both",
                             k = 3,
                             method = "ward.D2",
  ...
  tar_target(clust_fish_clean_PCs_scats_nopup_k3_ward_output, 
             clust_compo_PCs(PCA_fish_clean_scats_nopup_coda_rob,
                             "both",
                             k = 3,
                             method = "ward.D2",
                             "output",
                             "both_clean_nopup_coda_rob_k3_ward")),
  tar_target(boxplot_clust_fish_clean_PCs_scats_nopup_k3_ward, 
             boxplot_compo_clust(clust_fish_clean_PCs_scats_nopup_k3_ward_output,
                                 fish_sp_means_clean_and_scats_nopup,
                                 "both_PCs_clean_nopup_k3_ward")),
  tar_target(barplot_clust_fish_clean_PCs_scats_nopup_k3_ward, 
             barplot_clust(clust_fish_clean_PCs_scats_nopup_k3_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_PCs_clean_nopup_k3_ward")),
  tar_target(biplot_clust_fish_clean_PCs_scats_nopup_k3,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_fish_clean_PCs_scats_nopup_k3_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
  ...
  # trying on real concentrations using algorithm for compositional dataset
  # and only a few nutrients identified as structuring with PCAs
  tar_target(findk_ward_clust_nutrients_fish_clean_and_scats_nopup_output, 
             clust_find_k_table(fish_sp_means_clean_and_scats_nopup,
                                type = "both",
                                k = c(2:10),
                                nutrients = c("Fe", "Cu", 
                                              "As", "K", 
                                ...
                                method = "ward.D2",
                                object_type = "output")),
  tar_target(findk_ward_clust_nutrients_fish_clean_and_scats_nopup_file, 
             clust_find_k_table(fish_sp_means_clean_and_scats_nopup,
                                type = "both",
                                k = c(2:10),
                                nutrients = c("Fe", "Cu", 
                                ...
                                object_type = "file")),
  # k = 2
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "Cu", 
                                                "As", "K", 
                                                "Ca", "Na"),
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FeCuAsKCaNa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeCuAsKCaNa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  tar_target(clust_fish_clean_scats_nopup_nutrients_k2_dendro_type, 
             clust_compo_PCs_dendro_both_nut(fish_sp_means_clean_and_scats_nopup,
                                         nutrients = c("Fe", "Cu", 
                                                       "As", "K", 
                                                       "Ca", "Na"),
                                         k = 2, 
  ...
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_FePAsKCaNa_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "P", 
                                                "As", "K", 
                                  ...
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FePAsKCaNa_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_FePAsKCaNa_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FePAsKCaNa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FePAsKCaNa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_FePAsKCaNa_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                ...
                                var.add.scaling = 2.5)),
  # k = 3
  tar_target(clust_clust_nutrients_FeCuAsKCaNa_fish_clean_and_scats_nopup_k3_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "Cu", 
                                                "As", "K", 
                                  ...
                                  k = 3,
                                  method = "ward.D2")),
  tar_target(biplot_clust_clust_nutrients_FeCuAsKCaNa_fish_clean_and_scats_nopup_k3,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_FeCuAsKCaNa_fish_clean_and_scats_nopup_k3_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeCuAsKCaNa_k3_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_FeZnAsKCaNa_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "Zn", 
                                                "As", "K", 
                                  ...
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeZnAsKCaNa_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_FeZnAsKCaNa_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FeZnAsKCaNa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeZnAsKCaNa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeZnAsKCaNa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCu_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("K", "As", "Na", 
                                                "Fe", "Cu"),
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCu_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCu_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_KAsNaFeCu_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCu_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCu_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_KAsNaFeCu_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCuCa_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("K", "As", "Na", 
                                                "Fe", "Cu", "Ca"),
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCuCa_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCuCa_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_KAsNaFeCuCa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCuCa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_KAsNaFeCuCa_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_KAsNaFeCuCa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_FeAsNaKCuCa_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "As", "Na", 
                                                "K", "Cu", "Ca"),
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeAsNaKCuCa_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_FeAsNaKCuCa_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FeAsNaKCuCa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeAsNaKCuCa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_FeAsNaKCuCa_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeAsNaKCuCa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsKCa_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "Na", "Cu",
                                                "As", "K", "Ca"
                                                 ),
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsKCa_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsKCa_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FeNaCuAsKCa_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsKCa_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsKCa_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeNaCuAsKCa_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)), 
  
  # with other nutrients 
  tar_target(clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsK_k2_ward_output, 
             clust_compo_full_tib(fish_sp_means_clean_and_scats_nopup,
                                  type = "both",
                                  nutrients = c("Fe", "Na", "Cu",
                                                "As", "K"
                                  ...
                                  k = 2,
                                  method = "ward.D2")),
  tar_target(barplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsK_k2_ward, 
             barplot_clust(clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsK_k2_ward_output,
                           fish_sp_means_clean_and_scats_nopup,
                           "both_clean_nopup_nutrients_FeNaCuAsK_k2_ward")),
  tar_target(biplot_clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsK_k2,
             biplot_after_clust(PCA_fish_clean_scats_nopup_coda_rob,
                                clust_clust_nutrients_fish_clean_and_scats_nopup_FeNaCuAsK_k2_ward_output,
                                fish_sp_means_clean_and_scats_nopup,
                                "both",
                                "clean_nopup_nutrients_FeNaCuAsK_k2_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5))

...
list(
  ...
  tar_target(PCA_fish_tot_coda_rob, pca_coda(fish_sp_means_tot, 
                                             "fish")),
  tar_target(biplot_PCA_fish_tot_coda_rob, 
             biplot_pca_coda(PCA_fish_tot_coda_rob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_rob_PC12",
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = FALSE)),
  tar_target(biplot_PCA_fish_tot_coda_rob_ell, 
             biplot_pca_coda(PCA_fish_tot_coda_rob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_rob_PC12_ell",
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  tar_target(biplot_PCA_fish_tot_coda_rob_ell_PC13, 
             biplot_pca_coda(PCA_fish_tot_coda_rob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_rob_PC13_ell",
                             pcomp = c(1, 3), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  ...
  tar_target(PCA_fish_tot_coda_norob, pca_coda_norob(fish_sp_means_tot, 
                                                     "fish")),
  tar_target(biplot_PCA_fish_tot_coda_norob, 
             biplot_pca_coda(PCA_fish_tot_coda_norob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_norob_PC12",
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5, 
                             ellipse = FALSE)),
  tar_target(biplot_PCA_fish_tot_coda_norob_ell, 
             biplot_pca_coda(PCA_fish_tot_coda_norob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_norob_PC12_ell",
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5, 
                             ellipse = TRUE)),
  tar_target(biplot_PCA_fish_tot_coda_norob_ell_PC13, 
             biplot_pca_coda(PCA_fish_tot_coda_norob, 
                             fish_sp_means_tot, 
                             "fish_tot_coda_norob_PC13_ell",
                             pcomp = c(1,3), 
                             groups = "Family", 
                             var.add.scaling = 2.5, 
                             ellipse = TRUE)),
  ...
  tar_target(PCA_fish_tot_nocoda, pca_nocoda(fish_sp_means_tot, 
                                             "fish")),
  tar_target(biplot_PCA_fish_tot_nocoda_PC12, 
             biplot_pca_nocoda(PCA_fish_tot_nocoda, 
                               fish_sp_means_tot, 
                               groups = "Family", 
                               pcomp = c(1, 2),
                               "fish_tot_PC12")),
  tar_target(biplot_PCA_fish_tot_nocoda_PC13, 
             biplot_pca_nocoda(PCA_fish_tot_nocoda, 
                               fish_sp_means_tot, 
                               groups = "Family", 
                               pcomp = c(1, 3),
  ...
  tar_target(biplot_PCA_fish_clean_coda_rob_ell, 
             biplot_pca_coda(PCA_fish_clean_coda_rob, 
                             fish_sp_means_clean,
                             "fish_clean_coda_rob_PC12_ell",
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  tar_target(biplot_PCA_fish_clean_coda_rob_ell_PC13, 
             biplot_pca_coda(PCA_fish_clean_coda_rob, 
                             fish_sp_means_clean,
                             "fish_clean_coda_rob_PC13_ell",
                             pcomp = c(1, 3), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  ...
  tar_target(biplot_PCA_fish_clean_coda_norob_ell, 
             biplot_pca_coda(PCA_fish_clean_coda_norob, 
                             fish_sp_means_clean,
                             "fish_clean_coda_norob_PC12_ell", 
                             pcomp = c(1:2), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  tar_target(biplot_PCA_fish_clean_coda_norob_ell_PC13, 
             biplot_pca_coda(PCA_fish_clean_coda_norob, 
                             fish_sp_means_clean,
                             "fish_clean_coda_norob_PC13_ell", 
                             pcomp = c(1, 3), 
                             groups = "Family", 
                             var.add.scaling = 2.5,
                             ellipse = TRUE)),
  ...
  tar_target(biplot_PCA_fish_clean_nocoda, 
             biplot_pca_nocoda(PCA_fish_clean_nocoda, 
                               ...
                               pcomp = c(1, 2),
                               "fish_clean_PC12")),
  tar_target(biplot_PCA_fish_clean_nocoda_PC13, 
             biplot_pca_nocoda(PCA_fish_clean_nocoda, 
                               fish_sp_means_clean, 
                               groups = "Family", 
                               pcomp = c(1, 3),
  ...
  tar_target(biplot_PCA_fish_clean_scats_coda_rob,
             biplot_pca_coda(PCA_fish_clean_scats_coda_rob,
                             ...
                             "fish_clean_scats_PC12_coda_rob",
                             pcomp = c(1:2),
                             groups = "type",
                             var.add.scaling = 2.5,
                             ellipse = FALSE)),
  ...
  # dendrogram
  tar_target(clust_fish_PCs_tot_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                               fish_sp_means_tot,
                                                               method = "ward.D2", 
  ...
  tar_target(findk_ward_means_fish, means_clust_find_k_val(findk_ward_fish_output,
                                                           ...
                                                           file_name = "tot_PCs")),
  # k = 4
  tar_target(clust_fish_PCs_tot_k4_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              type = "fish",
                                                              k = 4,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k4_ward")),
  tar_target(clust_fish_PCs_tot_k4_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                type = "fish",
                                                                k = 4,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k4_ward")),
  tar_target(clust_fish_PCs_tot_k4_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 4, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_PCs_tot_k4_ward, boxplot_compo_clust(clust_fish_PCs_tot_k4_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_PCs_tot_k4_ward")),
  tar_target(barplot_clust_fish_PCs_tot_k4_ward, barplot_fam_clust(clust_fish_PCs_tot_k4_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_PCs_tot_k4_ward")),
  tar_target(biplot_clust_PCs_tot_k4_fish,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                clust_fish_PCs_tot_k4_ward_output,
                                fish_sp_means_tot,
                                "fish",
                                "PCs_tot_k4_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  # k = 2
  tar_target(clust_fish_PCs_tot_k2_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 2,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k2_ward")),
  tar_target(clust_fish_PCs_tot_k2_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 2,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k2_ward")),
  tar_target(clust_fish_PCs_tot_k2_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 2, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_PCs_tot_k2_ward, boxplot_compo_clust(clust_fish_PCs_tot_k2_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_PCs_tot_k2_ward")),
  tar_target(barplot_clust_fish_PCs_tot_k2_ward, barplot_fam_clust(clust_fish_PCs_tot_k2_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_PCs_tot_k2_ward")),
  tar_target(biplot_clust_fish_PCs_tot_k2,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                clust_fish_PCs_tot_k2_ward_output,
                                fish_sp_means_tot,
                                "fish",
  ...
  # k = 3
  tar_target(clust_fish_PCs_tot_k3_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 3,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k3_ward")),
  tar_target(clust_fish_PCs_tot_k3_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 3,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k3_ward")),
  tar_target(clust_fish_PCs_tot_k3_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 3, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_PCs_tot_k3_ward, boxplot_compo_clust(clust_fish_PCs_tot_k3_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_PCs_tot_k3_ward")),
  tar_target(barplot_clust_fish_PCs_tot_k3_ward, barplot_fam_clust(clust_fish_PCs_tot_k3_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_PCs_tot_k3_ward")),
  tar_target(biplot_clust_fish_PCs_tot_k3,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                clust_fish_PCs_tot_k3_ward_output,
                                fish_sp_means_tot,
                                "fish",
                                ...
                                var.add.scaling = 2.5)),
  # k = 5
  tar_target(clust_fish_PCs_tot_k5_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 5,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k5_ward")),
  tar_target(clust_fish_PCs_tot_k5_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 5,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k5_ward")),
  tar_target(clust_fish_PCs_tot_k5_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 5, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_PCs_tot_k5_ward, boxplot_compo_clust(clust_fish_PCs_tot_k5_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_PCs_tot_k5_ward")),
  tar_target(barplot_clust_fish_PCs_tot_k5_ward, barplot_fam_clust(clust_fish_PCs_tot_k5_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_PCs_tot_k5_ward")),
  tar_target(biplot_clust_fish_PCs_tot_k5,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                clust_fish_PCs_tot_k5_ward_output,
                                fish_sp_means_tot,
                                "fish",
                                ...
                                var.add.scaling = 2.5)),
  # k = 6
  tar_target(clust_fish_PCs_tot_k6_ward_file, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                              "fish",
                                                              k = 6,
                                                              method = "ward.D2",
                                                              "file",
                                                              "fish_tot_coda_rob_k6_ward")),
  tar_target(clust_fish_PCs_tot_k6_ward_output, clust_compo_PCs(PCA_fish_tot_coda_rob,
                                                                "fish",
                                                                k = 6,
                                                                method = "ward.D2",
                                                                "output",
                                                                "fish_tot_coda_rob_k6_ward")),
  tar_target(clust_fish_PCs_tot_k6_dendro, clust_compo_PCs_dendro(PCA_fish_tot_coda_rob,
                                                                  fish_sp_means_tot,
                                                                  method = "ward.D2", 
                                                                  k = 6, 
                                                                  colour = "Cluster", 
                                                                  file_name = "fish_tot_PCs")),
  tar_target(boxplot_clust_fish_PCs_tot_k6_ward, boxplot_compo_clust(clust_fish_PCs_tot_k6_ward_output,
                                                                     fish_sp_means_tot,
                                                                     "fish_PCs_tot_k6_ward")),
  tar_target(barplot_clust_fish_PCs_tot_k6_ward, barplot_fam_clust(clust_fish_PCs_tot_k6_ward_output,
                                                                   fish_sp_means_tot,
                                                                   "fish_PCs_tot_k6_ward")),
  tar_target(biplot_clust_fish_PCs_tot_k6,
             biplot_after_clust(PCA_fish_tot_coda_rob,
                                clust_fish_PCs_tot_k6_ward_output,
                                fish_sp_means_tot,
                                "fish",
  ...
  # using PCs of PCA computed with mean per species
  # dendrogram
  tar_target(clust_fish_PCs_clean_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                 fish_sp_means_clean,
                                                                 method = "ward.D2", 
                                                                 k = 3, # not useful here to colour by Family
                                                                 colour = "Family", 
  ...
  tar_target(findk_ward_means_fish_clean, means_clust_find_k_val(findk_ward_fish_clean_output,
                                                                 ...
                                                                 file_name = "clean_PCs")),
  # k = 4
  tar_target(clust_fish_PCs_clean_k4_ward_file, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = 4,
                                                                method = "ward.D2",
                                                                "file",
                                                                "fish_clean_coda_rob_k4_ward")),
  tar_target(clust_fish_PCs_clean_k4_ward_output, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = 4,
                                                                  method = "ward.D2",
                                                                  "output",
                                                                  "fish_clean_coda_rob_k4_ward")),
  tar_target(clust_fish_PCs_clean_k4_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                    fish_sp_means_clean,
                                                                    method = "ward.D2", 
                                                                    k = 4, 
                                                                    colour = "Cluster", 
                                                                    file_name = "fish_clean_PCs")),
  tar_target(boxplot_clust_fish_PCs_clean_k4_ward, boxplot_compo_clust(clust_fish_PCs_clean_k4_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_PCs_clean_k4_ward")),
  tar_target(barplot_clust_fish_PCs_clean_k4_ward, barplot_fam_clust(clust_fish_PCs_clean_k4_ward_output,
                                                                     fish_sp_means_clean,
                                                                     "fish_PCs_clean_k4_ward")),
  tar_target(biplot_clust_PCs_clean_k4_fish,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                clust_fish_PCs_clean_k4_ward_output,
                                fish_sp_means_clean,
                                "fish",
                                "PCs_clean_k4_ward",
                                pcomp = c(1:2),
                                var.add.scaling = 2.5)),
  # k = 5
  tar_target(clust_fish_PCs_clean_k5_ward_file, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                type = "fish",
                                                                k = 5,
                                                                method = "ward.D2",
                                                                "file",
                                                                "fish_clean_coda_rob_k5_ward")),
  tar_target(clust_fish_PCs_clean_k5_ward_output, clust_compo_PCs(PCA_fish_clean_coda_rob,
                                                                  type = "fish",
                                                                  k = 4,
                                                                  method = "ward.D2",
                                                                  "output",
                                                                  "fish_clean_coda_rob_k5_ward")),
  tar_target(clust_fish_PCs_clean_k5_dendro, clust_compo_PCs_dendro(PCA_fish_clean_coda_rob,
                                                                    fish_sp_means_clean,
                                                                    method = "ward.D2", 
                                                                    k = 4, 
                                                                    colour = "Cluster", 
                                                                    file_name = "fish_clean_PCs")),
  tar_target(boxplot_clust_fish_PCs_clean_k5_ward, boxplot_compo_clust(clust_fish_PCs_clean_k5_ward_output,
                                                                       fish_sp_means_clean,
                                                                       "fish_PCs_clean_k5_ward")),
  tar_target(barplot_clust_fish_PCs_clean_k5_ward, barplot_fam_clust(clust_fish_PCs_clean_k5_ward_output,
                                                                     fish_sp_means_clean,
                                                                     "fish_PCs_clean_k5_ward")),
  tar_target(biplot_clust_PCs_clean_k5_fish,
             biplot_after_clust(PCA_fish_clean_coda_rob,
                                clust_fish_PCs_clean_k5_ward_output,
                                fish_sp_means_clean,
                                "fish",
                                "PCs_clean_k5_ward",
                                pcomp = c(1:2),
  ...
  tar_target(barplot_clust_scats_PCs_tot_k4_ward, barplot_fam_clust(clust_scats_PCs_tot_k4_ward_output,
                                                                    full_res_compo_scats,
                                                                    "scats_PCs_tot_k4_ward")),
  ...
  tar_target(barplot_clust_scats_PCs_tot_k2_ward, barplot_fam_clust(clust_scats_PCs_tot_k2_ward_output,
                                                                    full_res_compo_scats,
                                                                    "scats_PCs_tot_k2_ward")),
  ...
  tar_target(barplot_clust_scats_PCs_tot_k3_ward, barplot_fam_clust(clust_scats_PCs_tot_k3_ward_output,
                                                                    full_res_compo_scats,
                                                                    "scats_PCs_tot_k3_ward")),
  tar_target(biplot_clust_scats_PCs_tot_k3,
             biplot_after_clust(PCA_scats_tot_coda_rob,
                                ...
                                var.add.scaling = 2.5)),
  # k = 5
  tar_target(clust_scats_PCs_tot_k5_ward_file, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                               "scats",
                                                               k = 5,
                                                               method = "ward.D2",
                                                               "file",
                                                               "scats_tot_coda_rob_k5_ward")),
  tar_target(clust_scats_PCs_tot_k5_ward_output, clust_compo_PCs(PCA_scats_tot_coda_rob,
                                                                 "scats",
                                                                 k = 5,
                                                                 method = "ward.D2",
                                                                 "output",
                                                                 "scats_tot_coda_rob_k5_ward")),
  tar_target(boxplot_clust_scats_PCs_tot_k5_ward, boxplot_compo_clust(clust_scats_PCs_tot_k5_ward_output,
                                                                      full_res_compo_scats,
                                                                      "scats_PCs_tot_k5_ward")),
  tar_target(barplot_clust_scats_PCs_tot_k5_ward, barplot_fam_clust(clust_scats_PCs_tot_k5_ward_output,
                                                                    full_res_compo_scats,
                                                                    "scats_PCs_tot_k5_ward")),
  tar_target(biplot_clust_scats_PCs_tot_k5,
             biplot_after_clust(PCA_scats_tot_coda_rob,
                                clust_scats_PCs_tot_k5_ward_output,
                                full_res_compo_scats,
                                "scats",
                                "PCs_tot_coda_rob_k5_ward",
                                pcomp = c(1:2),
  ...
  tar_target(barplot_clust_scats_PCs_nopup_k2_ward, barplot_fam_clust(clust_scats_PCs_nopup_k2_ward_output,
                                                                      full_res_compo_scats_nopup,
                                                                      "scats_PCs_nopup_k2_ward")),
  ...
  tar_target(barplot_clust_scats_PCs_nopup_k3_ward, barplot_fam_clust(clust_scats_PCs_nopup_k3_ward_output,
                                                                      full_res_compo_scats_nopup,
                                                                      "scats_PCs_nopup_k3_ward")),
